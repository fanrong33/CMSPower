      ...
      <div class="server">
        <table width="100%">
		  ...
		  <tr>
            ...
            <td><div id="J_install_tip_dbhost"><span class="gray" title="PHP5.3使用IPV6，对localhost可能会有点迟钝，需要解析时间，
直接127.0.0.1告诉他你用的IPV4，毫秒开">数据库服务器地址，一般为127.0.0.1</span></div></td>
          </tr>
		  <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="dbpw" id="dbpw" value="" class="input" autoComplete="off" onblur="test_db_password()"></td>
            <td><div id="J_install_tip_dbpw"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库名：</td>
            <td><input type="text" name="dbname" id="dbname" value="<?php echo date('Y');?>_cmspower" class="input" onblur="test_db_password()"></td>
            <td><div id="J_install_tip_dbname"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库表前缀：</td>
            <td><input type="text" name="dbprefix" id="dbprefix" value="t_" class="input"></td>
            <td><div id="J_install_tip_dbprefix"><span class="gray">不能修改，目前仅支持该前缀</span></div></td><!-- 建议使用默认，同一数据库安装多个CMSPower时需修改 -->
          </tr>
        </table>
		<table width="100%">
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="sitename" value="CMSPower云内容管理系统" class="input"></td>
          ...
          <tr>
            <td class="tar">关键词：</td>
            <td><input type="text" name="sitekeywords" value="CMSPower,极简,强大,云内容管理系统" class="input" autoComplete="off"></td>
            <td><div id="J_install_tip_sitekeywords"></div></td>
          </tr>
          <tr>
            <td class="tar">描述：</td>
            <td><input type="text" name="siteinfo" class="input" value="极简、强大的云内容管理系统，开源、免费、自由，致力于为您提供极致的开发体验。"></td>
...
$(function(){
	...
	var focus_tips = {
		...
		dbpw : '',
		dbname : '',
		dbprefix : '不能修改，目前仅支持该前缀', // 建议使用默认，同一数据库安装多个时需修改
